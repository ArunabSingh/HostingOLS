...
def results(request, choice, gmat):
    print("*** Inside reults()")
    # load saved model
    with open('C:/Users/sjind/ASingh/BCIT-4th-term/BigDataAnalytics/DjangoCode/LessonWk8/model_pkl', 'rb') as f:
...
def arunabPageView(request):
    # return request object and specify page.
    return render(request, 'arunab.html')
